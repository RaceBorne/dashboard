...
import { NewVentureButton } from '@/components/plays/NewVentureButton';
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="rounded-xl bg-evari-surface p-5 space-y-2">
          ...
          <p className="text-sm text-evari-dim leading-relaxed max-w-3xl">
            Each venture is a living workbook — brief, research, target list,
            ...
            the stages when it's ready. Leads generated by a live venture
