...
const NAV = [
  ...
  { href: '/screensaver', label: 'Screensaver', icon: Sparkles, group: 'today' },
                ...
                return items.map((item) => {
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      !collapsed && isChild
                        ...
                        : 'text-base',
                      active
                        ? 'bg-evari-gold text-evari-goldInk font-semibold shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]'
                  ...
                  >
                    <Icon
                      className={cn(
                        'h-4 w-4 shrink-0',
                        active ? 'text-evari-goldInk' : 'text-evari-dimmer',
                      )}
                    />
                    {!collapsed ? (
                      <>
